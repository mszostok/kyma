...
func TestAddonController_FetchingError(t *testing.T) {
	...
	assert.Equal(t, v1alpha3.AddonStatusFailed, ta.Addon.Status)
	assert.Equal(t, v1alpha3.AddonFetchingError, ta.Addon.Reason)
...
func TestAddonController_LoadingError(t *testing.T) {
	...
	assert.False(t, ta.IsReady())
	assert.Equal(t, v1alpha3.AddonStatusFailed, ta.Addon.Status)
	assert.Equal(t, v1alpha3.AddonLoadingError, ta.Addon.Reason)
...
func TestAddonController_ConflictInSpecifiedRepositories(t *testing.T) {
	...
	assert.False(t, ta.IsReady())
	assert.Equal(t, v1alpha3.AddonStatusFailed, ta.Addon.Status)
	assert.Equal(t, v1alpha3.AddonConflictInSpecifiedRepositories, ta.Addon.Reason)
...
func TestAddonController_ConflictWithAlreadyRegisteredAddons(t *testing.T) {
	...
	assert.False(t, ta.IsReady())
	assert.Equal(t, v1alpha3.AddonStatusFailed, ta.Addon.Status)
	assert.Equal(t, v1alpha3.AddonConflictWithAlreadyRegisteredAddons, ta.Addon.Reason)
...
func TestAddonController_RegisteringError(t *testing.T) {
	...
	assert.False(t, ta.IsReady())
	assert.Equal(t, v1alpha3.AddonStatusFailed, ta.Addon.Status)
	assert.Equal(t, v1alpha3.AddonRegisteringError, ta.Addon.Reason)
