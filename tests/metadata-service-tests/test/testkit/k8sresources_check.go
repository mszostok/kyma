...
import (
	...
	istio "github.com/mszostok/kyma/components/metadata-service/pkg/apis/istio/v1alpha2"
	remoteenv "github.com/mszostok/kyma/components/remote-environment-broker/pkg/apis/applicationconnector/v1alpha1"
